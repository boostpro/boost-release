 ...
 * $Header: /cvsroot/boost/boost/libs/graph/src/graphviz_graph_lex.cpp,v 1.2 2001/11/02 22:50:23 jsiek Exp $
 */
...
#ifndef YY_NO_INPUT
#ifdef __cplusplus
static int bgl_undir_input YY_PROTO(( void ));
#else
...
#define YY_INPUT(buf,result,max_size) \
	...
	else if ( ((result = fread( buf, 1, max_size, bgl_undir_in )) == 0) \
		  && ferror( bgl_undir_in ) ) \
		YY_FATAL_ERROR( "input in flex scanner failed" );
#endif
 ...
 */
#ifndef YY_DECL
#define YY_DECL int bgl_undir_lex YY_PROTO(( void ))
#endif
...
#line 629 "lex.yy.c"
	...
	if ( yy_init )
		...
		if ( ! yy_current_buffer )
			yy_current_buffer =
				bgl_undir_create_buffer( bgl_undir_in, YY_BUF_SIZE );
...
case YY_STATE_EOF(Literal):
	...
	case YY_END_OF_BUFFER:
		...
		int yy_amount_of_matched_text = (int) (yy_cp - bgl_undir_text_ptr) - 1;
		...
		*yy_cp = yy_hold_char;
		...
		if ( yy_current_buffer->yy_buffer_status == YY_BUFFER_NEW )
			...
			yy_current_buffer->yy_input_file = bgl_undir_in;
		...
		if ( yy_c_buf_p <= &yy_current_buffer->yy_ch_buf[yy_n_chars] )
			...
			yy_bp = bgl_undir_text_ptr + YY_MORE_ADJ;
			...
			case EOB_ACT_END_OF_FILE:
				...
				if ( yywrap() )
					 ...
					 */
					yy_c_buf_p = bgl_undir_text_ptr + YY_MORE_ADJ;
			...
			case EOB_ACT_CONTINUE_SCAN:
				yy_c_buf_p =
					bgl_undir_text_ptr + yy_amount_of_matched_text;
...
static int yy_get_next_buffer()
	...
	register char *source = bgl_undir_text_ptr;
	...
	if ( yy_current_buffer->yy_fill_buffer == 0 )
		...
		if ( yy_c_buf_p - bgl_undir_text_ptr - YY_MORE_ADJ == 1 )
			{
	...
	number_to_move = (int) (yy_c_buf_p - bgl_undir_text_ptr) - 1;
...
"input buffer overflow, can't enlarge buffer because scanner uses REJECT" );
	...
	bgl_undir_text_ptr = &yy_current_buffer->yy_ch_buf[0];
...
static yy_state_type yy_get_previous_state()
	...
	for ( yy_cp = bgl_undir_text_ptr + YY_MORE_ADJ; yy_cp < yy_c_buf_p; ++yy_cp )
		{
	...
	if ( *yy_c_buf_p == YY_END_OF_BUFFER_CHAR )
		...
		if ( yy_c_buf_p < &yy_current_buffer->yy_ch_buf[yy_n_chars] )
			...
			*yy_c_buf_p = '\0';
			...
			{ /* need more input */
			int offset = yy_c_buf_p - bgl_undir_text_ptr;
			++yy_c_buf_p;
			...
			switch ( yy_get_next_buffer() )
				...
				case EOB_ACT_CONTINUE_SCAN:
					yy_c_buf_p = bgl_undir_text_ptr + offset;
					break;
				}
			}
		}
...
#else
void bgl_undir_restart( input_file )
FILE *input_file;
#endif
	{
	if ( ! yy_current_buffer )
	...
	bgl_undir_init_buffer( yy_current_buffer, input_file );
	bgl_undir_load_buffer_state();
	}
